...
namespace App1
{
    public sealed partial class DynamicGraph : UserControl
    {
        public DynamicGraph()
        {
        ...
        public float Ratio
        {
            ...
            set { SetValue(RatioProperty, value); updateCurve(); }
        }

        // Using a DependencyProperty as the backing store for Ratio.  This enables animation, styling, binding, etc...
        public static readonly DependencyProperty RatioProperty =
            DependencyProperty.Register("Ratio", typeof(float), typeof(DynamicGraph), new PropertyMetadata((1 / 1.1f)));
        ...
        {
                float fractionalValue = ((float)threshHoldValue).Remap(-80.0f, 0.0f, 0.0f, 1f);;
